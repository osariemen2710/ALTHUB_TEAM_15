          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  name="email"
                  id="email"
                  className="block w-full pl-10 pr-3 py-2 bg-transparent text-gray-600 border border-gray-300 rounded-md focus:outline-none focus:ring-binit-green focus:border-binit-green sm:text-sm"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a
                  ...
                  className="font-medium text-binit-green hover:text-binit-green"
                >
                  Forgot password
                </a>
              </div>
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <LogIn
                  className="h-5 w-5 text-binit-green group-hover:text-binit-green"
                  aria-hidden="true"
                />
              </span>
              Log In
