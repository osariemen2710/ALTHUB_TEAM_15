...
export default function SideBar() {
  ...
  <button
   ...
   <aside className="w-64 min-h-screen bg-white border-r border-neutral-200 p-4 flex-col justify-between hidden md:flex fixed md:relative z-50">
  {/* Logo */}
  <img 
    src={logo}
    className="w-20 mb-5"
  ...
  <div className="flex items-center gap-3 mt-auto">
    ...
    <div className="flex flex-col">
      <h3 className="font-medium">Jessica Diop</h3>
      <p className="text-sm text-gray-500">jesse24@gmail.com</p>
    </div>
    <LogOut />
  </div>
</aside>
